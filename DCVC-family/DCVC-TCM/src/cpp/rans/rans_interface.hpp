...
public:
  ...
  void set_cdf(const std::vector<std::vector<int32_t>> &cdfs,
               const std::vector<int32_t> &cdfs_sizes,
               const std::vector<int32_t> &offsets);
  ...
  std::vector<int32_t>  
  decode_stream_only_indexes(const std::vector<int32_t> &indexes);
...
private:
  ...
  std::vector<std::vector<int32_t>> m_cdfs;
  std::vector<int32_t> m_cdfs_sizes;
