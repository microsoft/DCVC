...
from src.utils.common import str2bool, create_folder, generate_log_json, generate_log_json_simple, dump_json
...
def parse_args():
    ...
    parser.add_argument('--stream_path', type=str, default="/home/azureuser/cloudfiles/code/Users/juhcho/DCVC/DCVC-DC/out_bin")
    parser.add_argument('--save_decoded_frame', type=str2bool, default=False)
    parser.add_argument('--decoded_frame_path', type=str, default='/home/azureuser/cloudfiles/code/Users/juhcho/DCVC/DCVC-DC/decoded_frames')
    parser.add_argument('--output_path', type=str, required=True)
    parser.add_argument('--verbose', type=int, default=0)
    parser.add_argument('--encode_only', type=str2bool, default=False)
    parser.add_argument('--decode_only', type=str2bool, default=False)
...
def run_test(p_frame_net, i_frame_net, args):
    ...
    if save_decoded_frame:
        ...
        file1 = open(os.path.join(args['recon_path'],'bpp_n_psnr.txt'),"w")
        file1.write(folder_name)
        file1.close()
...
def encode_one(args):
    ...
    sub_dir_name = args['video_path'].split('.')[0]
    ...
    for ds_name in config:
        ...
        for seq_name in config[ds_name]['sequences']:
            ...
            for rate_idx in range(rate_num):
                ...
                cur_args['encode_only'] = args.encode_only
                cur_args['decode_only'] = args.decode_only
